  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen">
        {/* Hero */}
        <section className="px-6 md:px-12 pt-12 pb-10 md:pt-24 md:pb-16">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-[2rem] md:text-[5rem] font-black tracking-[-0.02em] md:tracking-[-0.04em] leading-[1.05] md:leading-tight max-w-4xl">
              PARLONS DE VOTRE{" "}
        ...
        <section className="px-4 md:px-12 pb-20 md:pb-32">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
            ...
            <div className="lg:col-span-5 space-y-12 md:space-y-16">
              <div>
                <h3 className="text-xl md:text-2xl font-bold mb-6 md:mb-8 uppercase tracking-tighter">
